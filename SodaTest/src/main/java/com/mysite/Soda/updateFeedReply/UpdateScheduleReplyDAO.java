...
public class UpdateScheduleReplyDAO {
	...
	public int updatereply(int reply_id, String scheduleVal, int userNum) {
		String sql = "UPDATE reply SET contents = :scheduleVal WHERE reply_id = :reply_id AND member_id = :userNum";
		params.addValue("reply_id", reply_id);
		params.addValue("scheduleVal", scheduleVal);
		params.addValue("userNum", userNum);
