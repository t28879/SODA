...
public class UpdateWorkReplyDAO {
	...
	public int updatereply(int reply_id, String workVal, int userNum) {
		String sql = "UPDATE reply SET contents = :workVal WHERE reply_id = :reply_id AND member_id = :userNum";
		params.addValue("workVal", workVal);
		params.addValue("reply_id", reply_id);
		params.addValue("userNum", userNum);
