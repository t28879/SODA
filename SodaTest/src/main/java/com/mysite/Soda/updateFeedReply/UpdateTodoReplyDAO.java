...
public class UpdateTodoReplyDAO {
	...
	public int updatereply(int reply_id, String todoVal, int userNum) {
		String sql = "UPDATE reply SET contents = :todoVal WHERE reply_id = :reply_id AND member_id = :userNum";
		params.addValue("reply_id", reply_id);
		params.addValue("todoVal", todoVal);
		params.addValue("userNum", userNum);
